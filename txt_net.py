...
def txt_net_strucuture(text_input, dimy, bit):
    W_fc8 = tf.compat.v1.random_normal([1, dimy, 1, LAYER1_NODE], stddev=1.0) * 0.01
    b_fc8 = tf.compat.v1.random_normal([1, LAYER1_NODE], stddev=1.0) * 0.01
    ...
    W_fc2 = tf.compat.v1.random_normal([1, 1, LAYER1_NODE, bit], stddev=1.0) * 0.01
    b_fc2 = tf.compat.v1.random_normal([1, bit], stddev=1.0) * 0.01
